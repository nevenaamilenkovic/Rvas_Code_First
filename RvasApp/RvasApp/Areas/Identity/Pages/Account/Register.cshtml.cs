...
namespace RvasApp.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //prilikom kreiranja naloga podrazumevana rola je polaznik
                    await _userManager.AddToRoleAsync(user, Roles.Polaznik.ToString());
